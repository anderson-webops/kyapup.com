...
function errorMessage(cause: unknown) {
  ...
  const explanations: Record<string, string> = {
    ...
    login_busy: 'Sign-in is busy. Please try again in a moment.',
    secondary_login_locked: 'Too many incorrect attempts. This password is paused on your network for 48 hours. Jacob can still sign in with his password.',
    secondary_login_unavailable: 'This password is temporarily unavailable. Please ask Jacob for help signing in.',
